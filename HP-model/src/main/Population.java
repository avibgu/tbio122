...
public class Population extends ArrayList<Protein>
{
   ...
   public final Sequence sequence;
    ...
    /**
     * Instantiates a new population. filling the population with random (Legal) Proteins
     *
    ...
    public Population (Configuration config, Random rand, MutationManager mutationManger) {
        ...
        for (int i=0; i<size; i++) {
            Protein protein = new Protein(dimensions, sequence, random, grid, "protein"+i);
            add(protein);
...
/**
    ...
    /**
     * Choose one of the proteins, with higher probability to the lower list position (better fitness)
