...
public class MutationLibrary {
	...
	private Hashtable<Vector3f, LinkedList<MutationLibraryEntry>> data;
	...
	public MutationLibrary() {
		data = new Hashtable<Vector3f, LinkedList<MutationLibraryEntry>>();
		size = 0;
	}
	...
	public void put(Vector3f key, MutationLibraryEntry element) {
		if (!data.containsKey(key))
			data.put(key, new LinkedList<MutationLibraryEntry>());
	 ...
	 */
	public LinkedList<MutationLibraryEntry> get(Vector3f key) {
        LinkedList<MutationLibraryEntry> out= new LinkedList<MutationLibraryEntry>(data.get(key));
		return out;
	}
